...
export function buildCheckout(body = {}) {
  ...
  for (const item of requested) {
    ...
    const unitAmount = isSupportTest ? SUPPORT_PROMO_UNIT_AMOUNT : product.price;
    if (unitAmount <= 0) {
      return {
        ok: false,
        status: 400,
  ...
  const shipping = isSupportTest ? supportTestShipping() : calculateShipping(shippingCountry, subtotal, quantity);
